...
def train():
    ...
    model.fit(X_train, y_train, epochs=MaxIter, batch_size=bsz, validation_split = 0.2, callbacks=callbacks_list)

weights_path='/home/mateus/Keras/oficeDL/Weights-007--0.01700.hdf5'
